...
import { Card, Col, Image, Nav, NavDropdown, Row, Tab } from "react-bootstrap";
...
interface RadicacionExtractedViewProps { 
    extractedInfo?: any;
    files?: any;
}

const RadicacionExtractedView: React.FC<RadicacionExtractedViewProps> = ({ extractedInfo, files }) => {
            ...
            <Row>
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className="">
                            <Nav className=" nav-tabs border-0 gap-sm-0 gap-1">
                                <Nav.Item>
                ...
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className="">
                            <Nav className="nav-pills gap-sm-0 gap-1" defaultActiveKey="4">
                                <Nav.Item>
                                    <Nav.Link eventKey="4" className="active" aria-current="page" >Active</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                            ...
                            <Card.Body className="">
                                ...
                                <Tab.Content className="">
                                    <Tab.Pane eventKey="home" className="text-muted" id="home1" role="tabpanel">
                                        <div className="mb-0">
                                            <h6 className="fw-semibold mb-3">Datos del Prestador</h6>
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <p><strong>NIT:</strong> {extractedInfo?.prestador?.nit || 'No disponible'}</p>
                                                    <p><strong>Nombre:</strong> {extractedInfo?.prestador?.nombre || 'No disponible'}</p>
                                                </div>
                                            </div>
                                            
                                            <h6 className="fw-semibold mb-3 mt-4">Datos de la Factura</h6>
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <p><strong>Número:</strong> {extractedInfo?.factura?.numero || 'No disponible'}</p>
                                                    <p><strong>Fecha Expedición:</strong> {extractedInfo?.factura?.fecha_expedicion || 'No disponible'}</p>
                                                    <p><strong>Valor Total:</strong> ${extractedInfo?.factura?.valor_total?.toLocaleString() || '0'}</p>
                                                </div>
                                                <div className="col-md-6">
                                                    <p><strong>Valor Bruto:</strong> ${extractedInfo?.factura?.resumen_monetario?.valor_bruto?.toLocaleString() || '0'}</p>
                                                    <p><strong>Valor Final a Pagar:</strong> ${extractedInfo?.factura?.resumen_monetario?.valor_final_pagar?.toLocaleString() || '0'}</p>
                                                </div>
                                            </div>

                                            {extractedInfo?.factura?.sector_salud && (
                                                <>
                                                    <h6 className="fw-semibold mb-3 mt-4">Sector Salud (XML)</h6>
                                                    <div className="row">
                                                        <div className="col-md-12">
                                                            <p><strong>Modalidad de Pago:</strong> {extractedInfo.factura.sector_salud.modalidad_pago || 'No disponible'}</p>
                                                            <p><strong>Cobertura:</strong> {extractedInfo.factura.sector_salud.cobertura_plan_beneficios || 'No disponible'}</p>
                                                            <p><strong>Contrato:</strong> {extractedInfo.factura.sector_salud.numero_contrato || 'No disponible'}</p>
                                                        </div>
                                                    </div>
                                                </>
                                            )}
                                    ...
                                    <Tab.Pane eventKey="about" className=" text-muted" id="about1" role="tabpanel">
                                        <div className="mb-0">
                                            <h6 className="fw-semibold mb-3">Estadísticas de Servicios RIPS</h6>
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <p><strong>Total Usuarios:</strong> {extractedInfo?.servicios?.estadisticas?.total_usuarios || 0}</p>
                                                    <p><strong>Tipo Principal:</strong> {extractedInfo?.servicios?.tipo_principal || 'No determinado'}</p>
                                                    <p><strong>Modalidad Inferida:</strong> {extractedInfo?.servicios?.modalidad_inferida || 'No determinado'}</p>
                                                </div>
                                            </div>

                                            <h6 className="fw-semibold mb-3 mt-4">Detalle de Servicios</h6>
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <p><strong>Consultas:</strong> {extractedInfo?.servicios?.detalle_completo?.consultas || 0}</p>
                                                    <p><strong>Procedimientos:</strong> {extractedInfo?.servicios?.detalle_completo?.procedimientos || 0}</p>
                                                    <p><strong>Urgencias:</strong> {extractedInfo?.servicios?.detalle_completo?.urgencias || 0}</p>
                                                </div>
                                                <div className="col-md-6">
                                                    <p><strong>Medicamentos:</strong> {extractedInfo?.servicios?.detalle_completo?.medicamentos || 0}</p>
                                                    <p><strong>Hospitalización:</strong> {extractedInfo?.servicios?.detalle_completo?.hospitalizacion || 0}</p>
                                                    <p><strong>Otros Servicios:</strong> {extractedInfo?.servicios?.detalle_completo?.otros_servicios || 0}</p>
                                                </div>
                                            </div>

                                            {extractedInfo?.pacientes_multiples && extractedInfo.pacientes_multiples.length > 0 && (
                                                <>
                                                    <h6 className="fw-semibold mb-3 mt-4">Pacientes Identificados</h6>
                                                    <p><strong>Total Pacientes:</strong> {extractedInfo.pacientes_multiples.length}</p>
                                                    <div className="alert alert-info">
                                                        <i className="ri-information-line me-2"></i>
                                                        Se detectaron múltiples pacientes en el archivo RIPS
                                                    </div>
                                                </>
                                            )}
                                        </div>
                                    ...
                                    <Tab.Pane eventKey="service" className=" text-muted" id="service1" role="tabpanel">
                                        <div className="mb-0">
                                            <h6 className="fw-semibold mb-3">Soportes Médicos Cargados</h6>
                                            
                                            {files?.soportes && files.soportes.length > 0 ? (
                                                <>
                                                    <p><strong>Total Archivos:</strong> {files.soportes.length}</p>
                                                    <div className="mb-3">
                                                        {files.soportes.map((file: any, index: number) => (
                                                            <div key={index} className="d-flex align-items-center mb-2 p-2 border rounded">
                                                                <div className="me-2">
                                                                    <i className={`ri-${file.name.toLowerCase().endsWith('.pdf') ? 'file-pdf' : 'file-zip'}-line fs-20 text-${file.name.toLowerCase().endsWith('.pdf') ? 'danger' : 'warning'}`}></i>
                                                                </div>
                                            ...
                                            <div className="mt-4">
                                                <h6 className="fw-semibold mb-2">Tipos de Soportes Según Resolución 2284</h6>
                                                <ul className="mb-0">
                                                    <li className="mb-1">Resumen de atención médica</li>
                                                    <li className="mb-1">Órdenes médicas y prescripciones</li>
                                                    <li className="mb-1">Epicrisis y notas de evolución</li>
                                                    <li className="mb-1">Comprobantes de medicamentos</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </Tab.Pane>
                    ...
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="hometab">
                            <Card.Body className="px-0">
                                ...
                                <Tab.Content className="px-3" id="myTabContent1">
                    ...
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="hometab1">
                            <Card.Body className=" px-1">
                                ...
                                <Tab.Content className="px-3" id="tab-style-4">
                ...
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="a">
                            <Card.Body className="custom-nav-tab">
                ...
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="drophome">
                            <Card.Body className="">
                                <Nav className=" nav-tabs mb-3 border-0 gap-sm-0 gap-1" role="tablist">
                                    <Nav.Item>
                    ...
                    <Card className="custom-card">
                        ...
                        <Tab.Container defaultActiveKey="pillproduct">
                            ...
                            <Tab.Content className="">
                                ...
                                <Tab.Pane eventKey="dropdown" className="text-muted" id="pill-products" role="tabpanel">
                                    How travel coupons make you a better lover. Why cultural solutions are the new
                                    black. Why mom was right about travel insurances. How family trip ideas can help
                                    you predict the future. <b>How carnival cruises make you a better lover</b>. Why
                                    you'll never succeed at daily deals.
...
export default RadicacionExtractedView;